...
import { ArrowLeft, Calendar, Camera, Loader2, Save, ShieldAlert, Trash2, User } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                 ...
                 <div className="lg:col-span-2 space-y-8">
                    <PanelCard
                        ...
                        icon={ShieldAlert}
                        contentClassName="space-y-6 px-6 pb-6"
                        actions={<InspectionRiskBadge level={inspectionData.riskLevel} withPrefix />}
                    >
                            <div>
              ...
              description="Documenta la solución implementada."
              icon={ShieldAlert}
