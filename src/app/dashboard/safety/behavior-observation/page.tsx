...
import { Loader2, Save, ChevronsUpDown, Check, CalendarIcon, Camera, Trash2, Eye } from "lucide-react";
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
           ...
           <PanelCard
              title="Observación de Conducta (Nivel de Riesgo)"
              icon={Eye}
        ...
        <div className="lg:col-span-1 space-y-6">
            <PanelCard
              title="Categoría Nivel de Riesgo"
              icon={Eye}
            >
                    <Controller
                        name="riskLevel"
            ...
            <PanelCard
              title="Foto de Registro (Opcional)"
              icon={Eye}
            >
                    <div className="space-y-2">
                        {evidencePhoto ? (
            ...
            <PanelCard
              title="Retroalimentación y Firmas"
              icon={Eye}
              contentClassName="space-y-4"
            >
                    <div className="space-y-2">
