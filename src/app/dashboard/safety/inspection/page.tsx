...
import { Loader2, Send, Camera, Trash2, Calendar as CalendarIcon, ShieldAlert } from "lucide-react";
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-8">
            <PanelCard
              title="Parte 1: Reporte de Observación"
              description="Llenado por APR, Administrador de Obra o Jefe de Bodega."
              icon={ShieldAlert}
        ...
        <div className="lg:col-span-1 space-y-8">
             <PanelCard
              title="Parte 2: Asignación y Cierre"
              description="Asigna un responsable y una fecha límite para resolver la observación."
              icon={ShieldAlert}
              contentClassName="space-y-4"
            >
                     <div className="space-y-2">
